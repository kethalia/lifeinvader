...
Clients order events by `(blockNumber, transactionIndex, logIndex)`. They must retain block hashes for unfinalized checkpoints and roll back events displaced by a chain reorganization.
